...
var GameBoard = function () {
  function GameBoard(rules, deck) {
    ...
    this.el.addEventListener('dblclick', function (e) {
      if (document.elementFromPoint(e.x, e.y).parentNode.isSameNode(_this[Symbols.deck])) {
        return false;
      }
